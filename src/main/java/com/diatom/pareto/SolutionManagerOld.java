 ...
 */
public class SolutionManagerOld {

	private static SolutionManagerOld instance;
	 ...
	 * @return
	 */
	public static SolutionManagerOld getInstance() {
		if(instance==null) instance = new SolutionManagerOld();
		return instance;
	}
	...
	*/
	 ...
	 */
	public Solution getCloneOfRandomSolution() {
		return (Solution) this.solutions.get(random.nextInt(this.solutions.size())).clone();
	}
	...
	public Solution getOptimalSolution() {
		...
		List<Solution> sortableSolutions = new ArrayList<Solution>(solutions);
